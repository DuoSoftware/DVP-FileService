...
RestServer.get('/DVP/API/'+version+'/FileService/FileInfo/FileCategory/:CategoryID/:rowCount/:pageNo',authorization({resource:"fileservice", action:"read"}),function(req,res,next)
{
    var reqId='';
    try {
