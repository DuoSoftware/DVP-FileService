...
/*
    ...
    if(req.body)
    {
        ...
        if(req.body.display)
        {
            ...
            reqFile.display = req.body.display;
        }
    ...
    try {
        ...
        FileHandler.DeveloperUploadFiles(reqFile,rand2,Company,Tenant,ref,option,Clz,Type,Category,resvID,reqId,function (errz,resUpload) {
